...
const variants = {
  primary: clsx(
    ...
    'border border-transparent bg-gray-950 shadow-md',
  ...
  secondary: clsx(
    ...
    'border border-transparent bg-white/15 shadow-md ring-1 ring-[#D15052]/15',
  ...
  outline: clsx(
    ...
    'border border-transparent shadow-sm ring-1 ring-black/10',
